...
// set the dimensions and margins of the graph
const margin2 = {top: 50, right: 30, bottom: 40, left: 150},
...
svg2.append("rect")
    ...
    .attr("y", 180)
    .attr("opacity",0.2)
// Select the div element by its ID or any other selector
var divElement = document.getElementById("line_chart");
...
var fall_area_width_M = 200
var fall_area_height_M = 600
